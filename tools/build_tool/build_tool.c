...
int main(){
    ...
    system("gcc ../../src/control/*.c ../../src/stats/stats_functions.c ../StringConcat/string_concat.c -o ../../out/control");
    ...
    system("gcc ../../src/stats/*.c ../StringConcat/string_concat.c -o ../../out/stats");
    printf("stats built\n");
